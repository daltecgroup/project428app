...
class AddonProvider extends GetConnect {
  ...
  Future<Response<Map<String, dynamic>>> createAddon(dynamic data) async {
  ...
  Future<Response<List<Addon>>> getAddons() async {
    final Response response = await get('$url?populate=recipe');
    if (response.isOk && response.body is List) {
      final List<dynamic> jsonList = response.body;
      final List<Addon> addons = jsonList
  ...
  Future<Response<Map<String, dynamic>>> updateAddon(
    String id,
    dynamic data,
  ) async {
    Map<String, dynamic> body = {};
    ...
    body['message'] = response.body['message'] as String;
    if (response.isOk) {
      body['addon'] = Addon.fromJson(response.body['addon']);
    }
  ...
  Future<Response<Map<String, dynamic>>> deleteAddon(String id) async {
    Map<String, dynamic> body = {};

...
class SpendGetPromoController extends GetxController {
  SpendGetPromoController({required this.data});
  ...
  PromoSetting? get currentPromoSetting =>
      data.getPromoSetting(AppConstants.PROMO_SETTING_SPEND_GET);

  Future<void> setMinimumPurchase() async {
